...
const styles = StyleSheet.create({
  ...
  priorityButton: { padding: 8, borderWidth: 1, borderColor: '#ccc', borderRadius: 6 },
  prioritySelected: { borderColor: '#1D3D47', backgroundColor: '#DDEFFF' },
  frequencyButton: { padding: 8, borderWidth: 1, borderColor: '#ccc', borderRadius: 6 },
  frequencySelected: { borderColor: '#1D3D47', backgroundColor: '#DDEFFF' },
  deviceCard: {
    flex: 1,
    minHeight: 100,
    borderWidth: 1,
